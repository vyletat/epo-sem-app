...
if (isset($_POST["action"])) {
    ...
    echo '<script>window.open(DashboardTemplate.tpl.phpate.tpl.php","_self")</script>';
}
...
if (!$login->isUserLoged()) {
    ...
    <form class="form-signin" method="POST">
        ...
        <input name="user[login]" type="text" id="inputNickname" class="form-control" placeholder="Login" required
               autofocus>

        <label for="inputPassword" class="sr-only">Password</label>
        <input name="user[password]" type="password" id="inputPassword" class="form-control" placeholder="Heslo"
               required>
        ...
        <button name="action" class="btn btn-lg btn-primary btn-block" type="submit" onclick="validateLogin()">
            Přihlásit
        </button>
    ...
    echo '<script>window.open("../private/DashboardTemplate.tpl.php","_self")</script>';
}
?>
</html>
